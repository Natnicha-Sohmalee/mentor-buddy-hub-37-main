...
export const pages: PageEntry[] = [
  ...
  { label: "รายละเอียดนัดหมาย", to: "/appointments/$appointmentId", roles: TM, group: "การทำงาน", nav: false },
  { label: "เอกสาร", to: "/documents", roles: ALL, group: "การทำงาน" },
  { label: "อัปโหลดเอกสาร", to: "/documents/upload", roles: TM, group: "การทำงาน" },
  { label: "รายละเอียดเอกสาร", to: "/documents/$documentId", roles: MA, group: "การทำงาน", nav: false },
  { label: "คลังความรู้", to: "/knowledge", roles: ALL, group: "ความรู้และการสื่อสาร" },
  { label: "บทความ", to: "/knowledge/$articleId", roles: ALL, group: "ความรู้และการสื่อสาร", nav: false },
  ...
  { label: "ค้นหา", to: "/search", roles: ALL, group: "บัญชี", nav: false },
...
export function navForRole(role: Role) {
  ...
  for (const page of pages) {
    if (page.nav !== false && page.roles.includes(role)) {
...
function pathMatches(pattern: string, pathname: string) {
  const expression = `^${pattern.replace(/\$[A-Za-z]+/g, "[^/]+")}/?$`;
