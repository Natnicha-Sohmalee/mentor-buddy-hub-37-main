...
export const pages: PageEntry[] = [
  ...
  { label: "นัดหมายและเอกสาร", to: "/appointments", roles: TM, group: "การทำงาน" },
  { label: "สร้างนัดหมาย", to: "/appointments/create", roles: TM, group: "การทำงาน" },
  { label: "เอกสาร", to: "/documents", roles: ALL, group: "การทำงาน", nav: false },
  { label: "อัปโหลดเอกสาร", to: "/documents/upload", roles: TM, group: "การทำงาน", nav: false },
