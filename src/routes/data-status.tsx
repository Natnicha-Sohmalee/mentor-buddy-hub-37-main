...
const live = ["ผู้ใช้และบทบาท", "โปรไฟล์เทรนนี่", "โปรไฟล์พี่เลี้ยง", "ทีมเทรนนี่ / ทีมพี่เลี้ยง / บ้าน", "ความสัมพันธ์พี่เลี้ยง–เทรนนี่", "โปรเจ็ค", "งานและการมอบหมายงาน", "นัดหมาย", "เอกสารและไฟล์", "คลังความรู้ / บทความ", "การแจ้งเตือน", "ปัญหาและ Feedback", "Standup และการลา", "คำขอขยายเวลา", "คำขอกำลังคน"];
const pending = ["รายงานและ Export (ต้องออกแบบรูปแบบรายงานก่อน)"];
